...
import (
	...
	"github.com/jclyons52/ts-go-morph/third_party/typescript-go/ts/testutil/autoimporttestutil"
	"github.com/jclyons52/ts-go-morph/third_party/typescript-go/ts/testutil/projecttestutil"
...
func TestHiddenDirectoriesInNodeModules(t *testing.T) {
	...
	t.Run("deep import through subdirectory package.json in hidden store", func(t *testing.T) {
		...
		// See https://github.com/jclyons52/ts-go-morph/third_party/typescript-go/issues/2780
		t.Parallel()
