...
func TestBuildDependencyUpdate(t *testing.T) {
	...
	testCases := []*tscInput{
		{
			// https://github.com/jclyons52/ts-go-morph/third_party/typescript-go/issues/2666
...
func TestBuildDeclarationEmitForReferencedProjectTypesSubpath(t *testing.T) {
	...
	testCases := []*tscInput{
		{
			// https://github.com/jclyons52/ts-go-morph/third_party/typescript-go/issues/3617
